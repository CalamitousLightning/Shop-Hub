/* =========================================================
   ShopHub Marketplace — orders.js
   Shows the logged-in customer's own orders from shophub_orders.
   ========================================================= */
  ...
  return `
    <div class="order-card">
      ...
      <div style="display:flex; justify-content:space-between; align-items:center; margin-top:6px;">
        <span class="order-total">${window.SHOPHUB_CONFIG.symbol} ${Number(order.total).toFixed(2)}</span>
