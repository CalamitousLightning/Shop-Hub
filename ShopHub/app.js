/* =========================================================
   ShopHub Marketplace — app.js (index.html)
   Fetches shophub_products, renders the grid, handles category
  ...
  return `
    <div class="product-card" data-id="${product.id}">
      ...
      <div class="product-body">
        ...
        <div class="price-row">
          <span class="price-currency">${window.SHOPHUB_CONFIG.symbol}</span>
...
supabaseClient
  .channel("shophub-products-realtime")
  .on("postgres_changes", { event: "*", schema: "public", table: "shophub_products" }, () => {
    loadProducts();
  })
  .subscribe();
...
function openModal(product) {
  ...
  document.getElementById("modalCurrency").textContent = window.SHOPHUB_CONFIG.symbol;
...
modalAddBtn.addEventListener("click", () => {
  ...
  ShopHubAddToCart(selectedProduct, selectedQty);
